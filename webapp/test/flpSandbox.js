		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Excel Download with formatting",
									"targetURL": "#ExcelDownloadwithformatting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ExcelDownloadwithformatting-display": {
								"semanticObject": "ExcelDownloadwithformatting",
								"action": "display",
								"description": "Excel Download with formatting",
								"title": "Excel Download with formatting",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.excel",
									"url": sap.ui.require.toUrl("com/sap/excel")
								}
							}
						}
					}
